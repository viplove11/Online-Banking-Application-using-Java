...
<head>
<meta charset="UTF-8" />
<title><%=username%> | Withdraw Page</title>
...
<body>
	...
	<div class="withdrawDiv">
		<form action="withdrawServlet" method="post" class="withdrawform">
			<h4 style="text-align: center; font-family: Josefin Sans;">Withdraw
				Amount</h4>
			<%
			...
			<div class="alert alert-danger" role="alert">
				<%=WithdrawMessage.equals("done") ? "Deposit successful!" : "Deposit failed!"%>
			</div>
			<%
			...
			%>
			<label>Withdrawl Amount :</label> <input class="form-control"
				placeholder="Rs. 2000" type="text" name="WithdrawAmount" required />
			<button class="btn btn-success" style="font-weight: 600;"
				type="submit">Withdraw Amount</button>
		</form>
	</div>
</body>
</html>
